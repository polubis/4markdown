  ...
  return (
    <>
      {replies.data.map((reply) => (
        <li key={reply.id} className="flex ml-12">
          <Avatar
              ...
              <div className="flex">
                {DOCUMENT_RATING_ICONS.map(([Icon, category]) => (
                  ...
                  >
                    ...
                    <strong>{reply.rating[category]}</strong>
                  </Button>
                ))}
              </div>
            </div>
                  ...
                  <li className="flex">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-center mt-2.5">
                        ...
                        <div className="w-1.5 h-1.5 rounded-full bg-gray-500 mx-2" />
                        <button
                          className="hover:underline underline-offset-2 mr-4 p-1"
                          onClick={() => toggleReplyVisibility(comment.id)}
                        >
                          {repliesVisibility[comment.id]
                            ? `Close (${comment.repliesCount})`
