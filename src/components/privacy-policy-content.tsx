  ...
  return (
    <main className="p-4 my-6 mx-auto prose dark:prose-invert">
      ...
      <p>
        ...
        {` `}
        <strong>{meta.appName}</strong>. By accessing or using our Service, you
      ...
      <ul>
        ...
        <li>
          Country: Where <strong>{meta.appName}</strong> or the owners/founders
          of <strong>{meta.appName}</strong>
          {` `}
          are based, in this case is Poland
        </li>
        <li>
          Customer: refers to the company, organization or person that signs up
          to use the <strong>{meta.appName}</strong> Service to manage the
        ...
        <li>
          ...
          <strong>{meta.appName}</strong> as described in the relative terms (if
      ...
      <h2>
        When does <strong>{meta.appName}</strong> use end user information from
        third parties?
      </h2>
      <p>
        <strong>{meta.appName}</strong> will collect End User Data necessary to
        provide the{` `}
      ...
      <h2>
        When does <strong>{meta.appName}</strong> use customer information from
        third parties?
      </h2>
      <p>
        ...
        in becoming a <strong>{meta.appName}</strong>
        {` `}
      ...
      <p>
        ...
        any information you transmit to{` `}
      ...
      <p>
        ...
        collected via our website, through direct interactions with you, or from
      ...
      <p>
        ...
        the assets of <strong>{meta.appName}</strong> or any of its Corporate
      ...
      <h2>Governing Law</h2>
      <p>
        This Privacy Policy is governed by the laws of Poland without regard to
      ...
      <p>
        By using <strong>{meta.appName}</strong> or contacting us directly, you
        signify your acceptance of this Privacy Policy. If you do not agree to
        this Privacy Policy, you should not engage with our website, or use our
        services. Continued use of the website, direct engagement with us, or
      ...
      <p>
        ...
        <strong>{meta.appName}</strong>. We are not responsible for the content,
        ...
        us. Please remember that when you use a link to go from the Services to
      ...
      <p>
        ...
        websites and services you use free of charge. We work hard to make sure
      ...
      <p>
        ...
        the content of any of the ads, promises made, or the quality/reliability
      ...
      <h2>Cookies</h2>
      <p>
        <strong>{meta.appName}</strong> uses &quot;Cookies&quot; to identify the
      ...
      <ul>
        <li>
          ...
          and functionality of our platform but are non-essential to their use.
          ...
          details every time you visit the platform as we would not be able to
        ...
        <li>
          ...
          data. Web storage supports persistent data storage, similar to cookies
          but with a greatly enhanced capacity and no information stored in the
          HTTP request header.
        </li>
        <li>
          <strong>Sessions</strong>: We use &quot;Sessions&quot; to identify the
          areas of our website that you have visited. A Session is a small piece
      ...
      <p>
        ...
        thing to do. At <strong>{meta.appName}</strong>
        {` `}
      ...
      <p>
        ...
        data in accordance with our Terms of Service and Privacy Policy, but we
