		...
		<>
			...
			>
				...
				<p>
					...
					information
					{` `}
					<strong>{meta.appName}</strong> collects depend on your relationship
					with{` `}
				...
				<h2>Use of Artificial Intelligence Services via OpenRouter</h2>
				<p>
					Certain features within <strong>{meta.appName}</strong> utilize
					Artificial Intelligence (AI) models accessed through{` `}
					<a
					...
					, a third-party service that aggregates various AI providers. When you
					use these features, the prompts and data you input are transmitted via
					OpenRouter to the selected third-party AI model provider (e.g.,
					OpenAI, Anthropic, Google, etc.) for processing.
				</p>
				<p>
					It is important to understand that these third-party AI providers may
					have their own data handling practices. Specifically, prompts and data
					submitted to these AI models via OpenRouter may be stored, analyzed,
					or otherwise used by the respective third-party providers according to
					their individual privacy policies and terms of service. This may be
					done for purposes such as model training, service improvement, safety
					monitoring, and compliance with legal obligations.
				</p>
				<p>
					While <strong>{meta.appName}</strong> facilitates access to these AI
					services through OpenRouter, we do not control the data processing
					practices of the ultimate third-party AI providers. We encourage you
					to review the privacy policies and terms of service of both OpenRouter
					and the specific AI model providers you may interact with through our
					Service to understand how your data is handled by them.{` `}
					<strong>{meta.appName}</strong> is not responsible for the data
					privacy or security practices of OpenRouter or any third-party AI
					providers accessed through it.
				</p>
				...
				<ul>
					<li>
						...
						and functionality of our platform but are non-essential to their
					...
					<li>
						<strong>Local Storage</strong>: Sometimes known as DOM storage,
						provides web apps with methods and protocols for storing client-side
						data. Web storage supports persistent data storage, similar to
						cookies but with a greatly enhanced capacity and no information
						stored in the HTTP request header.
					</li>
					<li>
						<strong>Sessions</strong>: We use &quot;Sessions&quot; to identify
				...
				<p>
					...
					years unless your account is deleted. In which case, we dispose of all
					data in accordance with our Terms of Service and Privacy Policy, but
