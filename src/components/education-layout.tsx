  ...
  return (
    <main className="md:flex max-w-[1280px] mx-auto relative">
      <section className="md:w-[100%] md:border-r-2 border-zinc-300 dark:border-zinc-800 py-6">
        ...
        <h1 className="text-3xl border-b-2 border-zinc-300 dark:border-zinc-800 pb-4 px-4 capitalize">
          {title}
        </h1>
        <div className="mx-4 mt-4 md:min-h-screen flex flex-col">{body}</div>
      </section>
