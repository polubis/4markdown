  ...
  return (
    <>
      <main className="md:flex max-w-[1280px] mx-auto relative">
        <section className="md:w-[100%] md:border-r border-zinc-300 dark:border-zinc-800 py-6">
          <p className="text-sm mb-0.5 capitalize px-4 md:px-6">{subTitle}</p>
          <h1 className="text-3xl border-b border-zinc-300 dark:border-zinc-800 pb-4 px-4 md:px-6 capitalize">
            {title}
          </h1>
        ...
        <section className="md:w-[400px] border-t md:border-t-0 border-zinc-300 dark:border-zinc-800">
