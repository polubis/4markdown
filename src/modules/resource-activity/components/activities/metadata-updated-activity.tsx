...
const MetadataUpdatedActivity = ({ activity }: MetadataUpdatedActivityProps) => {
  const tagsChanged =
  ...
  const hasPreviousDescription = activity.previousMeta.description && activity.previousMeta.description.trim().length > 0;
  const hasNewDescription = activity.newMeta.description && activity.newMeta.description.trim().length > 0;
