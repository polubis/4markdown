...
type DocumentCommentFormContainerProps = {
  mode: "edit" | "add";
  content?: string;
  commentId?: Atoms["DocumentCommentId"];
};

const DocumentCommentFormContainer = ({
  mode,
  content,
  commentId,
}: DocumentCommentFormContainerProps) => {
  const { commentForm } = useDocumentCommentsContext();
...
export type { DocumentCommentFormContainerProps };
export { DocumentCommentFormContainer };
