...
import { MindmapNodeCommentFormContainer } from "./mindmap-node-comment-form.container";
import { DocumentCommentsListLoader } from "modules/document-comments/components/document-comments-list-loader";
import { useMindmapNodeCommentsContext } from "../providers/mindmap-node-comments.provider";
import { MindmapNodeCommentsList } from "../components/mindmap-node-comments-list";
...
import { EmptyDocumentComments } from "modules/document-comments/components/empty-document-comments";
import { Err } from "design-system/err";

type MindmapNodeCommentsContainerProps = {
  className?: string;
};
...
const MindmapNodeCommentsContainer = ({
  ...
  return (
    <>
      ...
      {commentForm.is === "on" && (
        <MindmapNodeCommentFormContainer {...commentForm.data} />
      )}
    </>
  );
};

export { MindmapNodeCommentsContainer };
