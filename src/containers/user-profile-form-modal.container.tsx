        ...
        <Modal>
          ...
          {updateUserProfileStore.is === `ok` && (
            <>
              ...
              {userProfileStore.avatar && (
                <p className="mb-1 flex items-center">
                  Avatar:{` `}
                  <img
                    className={c(
                      `ml-2 h-6 w-6 object-cover rounded-full`,
                      `h-[${userProfileStore.avatar.tn.h}] w-[${userProfileStore.avatar.tn.w}]`,
                    )}
                    src={userProfileStore.avatar.tn.src}
                  />
                </p>
              )}
...
export default UserProfileFormModalContainer;
