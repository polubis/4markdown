...
const PrivacyPolicyPage = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-4xl p-4 mx-auto [&>p]:mb-2">
        <h1 className="text-4xl mb-2">Privacy Policy</h1>
        <p>Updated at 2024-05-17</p>
        <p>
          4markdown (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by 4markdown.
        </p>
        <p>
          ...
          4markdown. By accessing or using our Service, you signify that you
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to GreenOn Software Adrian Połubiński, Olsztyn,
              Pileckiego 6/19 10-693 that is responsible for your information
              under this Privacy Policy.
            </li>
            <li>
              Country: where 4markdown or the owners/founders of 4markdown are
              based, in this case is Poland
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the 4markdown Service to manage the relationships with
              your consumers or service users.
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit 4markdown
            ...
            <li>
              ...
              4markdown or are under contract to perform a service on behalf of
              one of the parties.
            </li>
            <li>
            ...
            <li>
              Service: refers to the service provided by 4markdown as described
            ...
            <li>
              Website: 4markdown&apos;s site, which can be accessed via this
              URL: https://4markdown.com
            </li>
            <li>
              You: a person or entity that is registered with 4markdown to use
              the Services.
            </li>
          </ul>
        </p>
        ...
        <h2>
          When does 4markdown use end user information from third parties?
        </h2>
        <p>
          4markdown will collect End User Data necessary to provide the
          4markdown services to our customers.
        </p>
        <p>
        ...
        <h2>
          When does 4markdown use customer information from third parties?
        </h2>
        <p>
          ...
          interest in becoming a 4markdown customer, we receive information from
          a third party that provides automated fraud detection services to
          4markdown. We also occasionally collect information that is made
        ...
        <p>
          ...
          reporting for us and our advertisers. We may also disclose personal
          and non-personal information about you to government or law
        ...
        <p>
          4markdown will collect personal information that you submit to us. We
        ...
        <p>
          ...
          4markdown to you and fulfill the purposes described in this policy.
        ...
        <p>
          ...
          absolute security of any information you transmit to 4markdown or
        ...
        <p>
          4markdown is incorporated in Poland. Information collected via our
        ...
        <h2>
          Is the information collected through the 4markdown Service secure?
        </h2>
        <p>
        ...
        <p>
          ...
          information 4markdown collects depend on your relationship with
          4markdown. Personnel may update or correct their information as
        ...
        <h1>Personnel</h1>
        <p>
          If you are a 4markdown worker or applicant, we collect information you
        ...
        <p>
          ...
          of the assets of 4markdown or any of its Corporate Affiliates (as
          defined herein), or that portion of 4markdown or any of its Corporate
        ...
        <p>
          ...
          control with 4markdown, whether by ownership or otherwise. Any
        ...
        <h2>Governing Law</h2>
        <p>
          This Privacy Policy is governed by the laws of Poland without regard
        ...
        <p>
          The laws of Poland, excluding its conflicts of law rules, shall govern
        ...
        <p>
          By using 4markdown or contacting us directly, you signify your
        ...
        <p>
          ...
          4markdown. We are not responsible for the content, accuracy or
        ...
        <p>
          ...
          party sites. 4markdown does not make any representation as to the
        ...
        <p>
          Advertising keeps 4markdown and many of the websites and services you
        ...
        <p>
          ...
          4markdown of the third party sites, goods or services. 4markdown takes
        ...
        <h2>Cookies</h2>
        <p>
          4markdown uses &quot;Cookies&quot; to identify the areas of our
        ...
        <p>
          ...
          It allows your company to seem like they&apos;re “following” people
          around the internet by serving ads on the websites and platforms they
          use most.
        </p>
        <h2>Kids&apos; Privacy</h2>
        <p>
        ...
        <p>
          You acknowledge and agree that 4markdown shall not be responsible for
          ...
          or any other aspect thereof. 4markdown does not assume and shall not
        ...
        <p>
          ...
          the right thing to do. At 4markdown we strongly believe that your data
        ...
        <p>
          ...
          requirements of GDPR. 4markdown processes or stores all personal data
          in fully vetted, DPA compliant vendors. We do store all conversation
          and personal data for up to 6 years unless your account is deleted. In
        ...
        <p>
          ...
          and your customers data. Our customer support team is here for you to
